import * as Gt from "../types/Generator.type.js";
import { FileIO } from "./FileIO.js";
import util from "util";

async function loadTemplates(): Promise<Gt.XamlTemplate> {
    return {
        components: {
            Apage: await new FileIO(
                "templates/xaml/components/Apage.xaml"
            ).readFile(),
            BtnCopy: await new FileIO(
                "templates/xaml/components/BtnCopy.xaml"
            ).readFile(),
            BtnIssue: await new FileIO(
                "templates/xaml/components/BtnIssue.xaml"
            ).readFile(),
            BtnLoad: await new FileIO(
                "templates/xaml/components/BtnLoad.xaml"
            ).readFile(),
            BtnRepo: await new FileIO(
                "templates/xaml/components/BtnRepo.xaml"
            ).readFile(),
            Footer: await new FileIO(
                "templates/xaml/components/Footer.xaml"
            ).readFile(),
            Framework: await new FileIO(
                "templates/xaml/components/Framework.xaml"
            ).readFile(),
            Header: await new FileIO(
                "templates/xaml/components/Header.xaml"
            ).readFile(),
        },
        markdown: {
        ...
        styles: {
            Icons: await new FileIO(
                "templates/xaml/styles/Icons.xaml"
            ).readFile(),
            PresetControls: await new FileIO(
                "templates/xaml/styles/PresetControls.xaml"
            ).readFile(),
            Styles: await new FileIO(
                "templates/xaml/styles/Styles.xaml"
            ).readFile(),
        },
    };
}
...
export class Generator {
    private xaml_template: null | Gt.XamlTemplate;
    constructor() {
